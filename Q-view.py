...
if st.sidebar.button("Ask", key="qchat_ask"):
    if not user_query:
        ...
        st.session_state.chat_response = "⚠ Q-Chat not configured. Put your OPENAI_API_KEY in secrets or env."
    else:
        with st.spinner("Thinking..."):
            try:
                ...
                st.session_state.chat_response = f"⚠ Q-Chat error: {e}"
...
if n_qubits:
    ...
    try:
        ...
        st.download_button("⬇ Download QASM", qasm_str, file_name="circuit.qasm")
    except Exception:
        pass
